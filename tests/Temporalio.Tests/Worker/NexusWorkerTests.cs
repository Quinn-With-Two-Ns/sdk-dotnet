...
#pragma warning restore CA1849, VSTHRD103
    ...
    private class CancelActivityOverrideHandler : TemporalNexusOperationHandler<string, string>
    {
        ...
        protected override Task CancelActivityExecutionAsync(
            NexusOperationCancelContext context, CancelActivityExecutionInput input)
        {
            CancelCallCount++;
